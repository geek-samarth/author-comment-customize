...
if ( ! class_exists( 'comment_customize_style_library_Styles' ) ) :
/**
 ...
 */
class comment_customize_style_library_Styles {

	/**
	 * The one instance of comment_customize_style_library_Styles.
	 *
	 * @since 1.0.0.
	 *
	 * @var   comment_customize_style_library_Styles    The one instance for the singleton.
	 */
	...
	/**
	 * Instantiate or return the one comment_customize_style_library_Styles instance.
	 *
	 * @since  1.0.0.
	 *
	 * @return comment_customize_style_library_Styles
	 */
	...
	private function parse_declarations( $declarations, $tab = '' ) {
		 ...
		 * routines are implemented when the developer calls `comment_customize_style_library_Styles()->add`. Because every property value has
...
if ( ! function_exists( 'comment_customize_style_library_styles' ) ) :
/**
 * Return the one comment_customize_style_library_Styles object.
 *
 * @since  1.0.0.
 *
 * @return comment_customize_style_library_Styles	The comment_customize_style_library_Styles object.
 */
function comment_customize_style_library_styles() {
	return comment_customize_style_library_Styles::instance();
}
endif;

add_action( 'init', 'comment_customize_style_library_styles', 1 );
?>